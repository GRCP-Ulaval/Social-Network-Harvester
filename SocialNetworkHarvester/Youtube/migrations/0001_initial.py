...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='ContentImage',
            fields=[
                ('image_time_label_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='SocialNetworkHarvester.Image_time_label')),
            ],
            options={
                'abstract': False,
            },
